				  ...
				  <div class="row top-sec">
				   <div class="col-lg-12">
					<div class="col-lg-2 col-xs-12">
					 <a href="model.php?a=overview&id='. escape($row->userid) .'">
					  <img class="img-responsive" src="Model/'. escape($imagelocation) .'" alt="">
					 </a>
					</div><!-- /.col-lg-2 -->
					<div class="col-lg-10 col-xs-12"> 
					 <h4><a href="model.php?a=services&id='. escape($row->userid) .'&sid='. escape($row->serviceid) .'">'. escape($row->title) .'</a></h4>
					 <h5><a href="model.php?a=overview&id='. escape($row->userid) .'">'. escape($name1) .'</a></h5>
					</div><!-- /.col-lg-10 -->
