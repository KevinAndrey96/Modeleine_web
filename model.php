...
<body class="greybg">
  ...
  background: linear-gradient(
      rgba(34,34,34,0.7), 
      rgba(34,34,34,0.7)
    ), url('Model/<?php echo $freelancer_bgimage; ?>') no-repeat center center fixed;
  ...
  text-align: center;">
      <div class="container">
	   <div class="content">
	    <div class="row">
	     <div class="col-lg-12">
          <img src="Model/<?php echo $freelancer_imagelocation; ?>" class="img-thumbnail img-responsive revealOnScroll" data-animation="fadeInDown" data-timeout="200" alt="">
	    ...
	    <div class="row">
		 ...
		 <div id="sidebar" class="col-lg-4">
			...
			<div class="list">
			 ...
			 <a href="model.php?a=overview&id=<?php echo $freelancerid ?>" class="list-group-item <?php echo $overview; ?> cat-list">
			  <em class="fa fa-fw fa-align-justify"></em>&nbsp;&nbsp;&nbsp;<?php echo $lang['overview']; ?>
			 </a>
			 <a href="model.php?a=portfolio&id=<?php echo $freelancerid ?>" class="list-group-item <?php echo $portfolio; ?> cat-list">
			  <em class="fa fa-fw fa-align-justify"></em>&nbsp;&nbsp;&nbsp;<?php echo $lang['portfolio']; ?>
			 </a>
			 <a href="model.php?a=services&id=<?php echo $freelancerid ?>" class="list-group-item <?php echo $services; ?> cat-list">
			  <em class="fa fa-fw fa-align-justify"></em>&nbsp;&nbsp;&nbsp;<?php echo $lang['services']; ?>
			 </a>
			 <a href="model.php?a=jobs&id=<?php echo $freelancerid ?>" class="list-group-item <?php echo $jobs; ?> cat-list">
			  <em class="fa fa-fw fa-align-justify"></em>&nbsp;&nbsp;&nbsp;<?php echo $lang['jobs']; ?> 
			                                                               <?php echo $lang['completed']; ?> &
			                                                               <?php echo $lang['assigned']; ?>
			 </a>
			 <a href="model.php?a=reviews&id=<?php echo $freelancerid ?>" class="list-group-item <?php echo $reviews; ?> cat-list">
					 ...
					 foreach($query->results() as $row) {
				      ...
				      echo $teamList .= '
						...
						<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 profile">
						  <div class="img-box">
							<img src="Model/'. escape($row->imagelocation) .'" class="img-responsive" alt="">
				  ...
				  <div class="row top-sec">
				   <div class="col-lg-12">
					...
					<div class="col-lg-12 col-xs-12"> 
					 <h4><a href="model.php?a=services&id='. escape($row->userid) .'&sid='. escape($row->serviceid) .'">'. escape($row->title) .'</a></h4>
					</div><!-- /.col-lg-12 -->
		  ...
		  <div class="row">
		   <div class="col-md-8 col-md-offset-2 text-center">
			<div class="image-wrapper">
			 <img class="img-responsive" src="Model/<?php echo $portfolio_imagelocation; ?>" alt="">
			</div>
			<!--./image-wrapper -->
		   </div><!--./col-md-8 -->
		  </div><!--./row -->
